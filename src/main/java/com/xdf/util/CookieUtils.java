...
public class CookieUtils {
     ...
     * 登录的时候保存的Cookie
     */
    public static final String COOKIE_NAME_LOGININFO = "account";

    /**
     * 订单运送到哪个国家
     */
    public static final String COOKIE_NAME_DESTINATION = "destination";


    /**
     * 订单运送到哪个国家
     */
    public static final String COOKIE_NAME_MTKBUYMANUFACTORYID = "mtkbuymanufactoryid";
