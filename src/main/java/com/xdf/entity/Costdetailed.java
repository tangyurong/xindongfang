...
public class Costdetailed {
  ...
  public long getCostDetailedId() {
    return costDetailedId;
  }

  public void setCostDetailedId(long costDetailedId) {
    this.costDetailedId = costDetailedId;
  }
